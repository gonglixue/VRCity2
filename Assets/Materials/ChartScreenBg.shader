...
#include "UnityCG.cginc"
	...
	v2f vert(float4 v : POSITION, float3 n : NORMAL)
	{
		...
		float3 viewDir = normalize(ObjSpaceViewDir(v));  // viewDir是在view坐标系下
	...
	half4 frag(v2f i) : SV_Target
	{
		...
		return half4(refraction.rgb * multiplier.rgb, _Color.a);
	}
		ENDCG
	}
...
#include "UnityCG.cginc"
	...
	half4 frag(v2f i) : SV_Target
	{
		...
		return fixed4(reflection2 + refraction.rgb*multiplier, _Color.a);
	}
		ENDCG
	}
